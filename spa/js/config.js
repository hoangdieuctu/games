...
export const CHAPTERS = [
  { name: 'Tiệm Nhỏ Đầu Phố', icon: '🏠',  from: 1,  to: 5  },
  { name: 'Spa Bên Bờ Biển',  icon: '🏖️', from: 6,  to: 10 },
...
const LEVELS = [
  /* ── Chương 1 · Tiệm Nhỏ Đầu Phố: học nghề ── */
  { st: [M, M],          ty: [LADY],                      w: [1, 1], n: 6,  gap: 9.4, f: 0.50 },
  { st: [M, M, F],       ty: [LADY, LADY, GRAN],          w: [1, 1], n: 8,  gap: 8.8, f: 0.52 },
  { st: [M, F, F, N],    ty: [LADY, LADY, GRAN],          w: [1, 2], n: 10, gap: 8.2, f: 0.54 },
  { st: [M, M, F, N],    ty: [LADY, LADY, GRAN, BIZ],     w: [1, 2], n: 12, gap: 7.6, f: 0.56 },
  { st: [M, M, F, F, N], ty: [LADY, LADY, GRAN, BIZ],     w: [1, 2], n: 14, gap: 7.2, f: 0.58 },

  /* ── Chương 2 · Spa Bên Bờ Biển: có phòng xông hơi ── */
